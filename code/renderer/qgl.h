...
#if 0
extern void (__stdcall qglActiveTextureARB) (GLenum texture);
extern void (__stdcall qglClientActiveTextureARB) (GLenum texture);
extern void (__stdcall qglMultiTexCoord2fARB) (GLenum target, GLfloat s, GLfloat t);

extern void (__stdcall qglLockArraysEXT) (GLint first, GLsizei count);
extern void (_stdcall qglUnlockArraysEXT) (void);
#endif

#define qwglMakeCurrent eglMakeCurrent
