...
void R_Register( void ) 
{
	...
	r_customwidth = ri.Cvar_Get( "r_customwidth", "480", CVAR_ARCHIVE | CVAR_LATCH );
	r_customheight = ri.Cvar_Get( "r_customheight", "320", CVAR_ARCHIVE | CVAR_LATCH );
