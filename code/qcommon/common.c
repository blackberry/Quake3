...
#ifdef RIM_NDK
	// bk001205 - was malloc
	s_hunkData = f_calloc( s_hunkTotal + 31, 1 );
#elif __QNXNTO__
...
=================
*/
void Com_RunAndTimeServerPacket( netadr_t *evFrom, qmsg_t *buf ) {
	int		t1, t2, msec;
...
int Com_Milliseconds (void) {
	...
	do {
      ...
      //  if (ev == NULL)
     //   {
      //      log_printf(LOG_WARN, "BAD POINTER");
      //      return 1337;
       // }
