...
==============
*/
static void SV_Netchan_Encode( client_t *client, qmsg_t *msg ) {
...
==============
*/
static void SV_Netchan_Decode( client_t *client, qmsg_t *msg ) {
...
void SV_Netchan_Transmit( client_t *client, qmsg_t *msg) {	//int length, const byte *data ) {
