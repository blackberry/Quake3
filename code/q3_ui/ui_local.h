...
// vkb related
#include <stdlib.h>        /* Header file for EXIT_FAILURE, EXIT_SUCCESS */
...
// ui_vkb.c
//
extern int vkb_m_keyboardControlFD;
extern pps_encoder_t vkb_m_encoder;
extern pps_decoder_t vkb_m_decoder;
extern char* vkb_gKeyboardControlPath;

extern void VKB_ShowKeyboard( void );
extern void VKB_HideKeyboard( void );
...
qboolean               UI_trap_VerifyCDKey( const char *key, const char *chksum); // bk001208 - RC4
